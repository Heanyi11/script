...
!(async () => {
  ...
  if ($.isNode() && allMessage) {
    await notify.sendNotify(`爱企查库存`, `${allMessage}` )
  } 
})()
  .catch((e) => {
      $.log('', `❌ ${$.name}, 失败! 原因: ${e}!`, '')
      ...
      $.get(url, async (err, resp, data) => {
          try {
              ...
              if (qqfh.status == 0 ) {
                ...
                if(qqfh.data.AQ03007 == true){
                  console.log(`【爱奇艺月卡有库存了，快去兑换！】`);
                  allMessage += `【爱奇艺月卡有库存了，快去兑换！】\n`

                }else{
                  console.log(`【【爱奇艺月卡没货】`);
                  
                }        
                if(qqfh.data.AQ03011 == true){
                  console.log(`【爱奇艺季卡有库存了，快去兑换！】`);
                  allMessage += `【爱奇艺季卡有库存了，快去兑换！】\n`
